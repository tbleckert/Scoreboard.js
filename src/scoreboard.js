...
var Scoreboard = new Class({
	...
	Binds: ['set', 'get', 'addGoal', 'removeGoal', 'resetGoals', 'startTime', 'stopTime', 'increaseTime', 'decreaseTime', 'resetTime', 'setName'],
	...
	setName: function (team, name, short) {
		short = (short) ? short : String.shortName(name);
